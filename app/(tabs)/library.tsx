...
export default function Library() {
  ...
  const getDifficultyColor = (difficulty: string) => {
    switch (difficulty) {
      case 'Beginner': return Colors.accent.success;
      case 'Intermediate': return Colors.accent.warning;
      case 'Advanced': return Colors.accent.error;
    ...
    <View style={styles.container}>
      ...
      <View style={styles.searchContainer}>
        ...
        <TouchableOpacity style={styles.filterButton}>
          <IconSymbol size={20} name="line.3.horizontal.decrease" color="#9cbab3" />
        </TouchableOpacity>
      </View>
